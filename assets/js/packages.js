      ...
      card.innerHTML = `
        ...
        <div class="absolute bottom-0 left-0 p-6 w-full">
          ...
          <div class="mt-4 flex items-center justify-between opacity-0 group-hover:opacity-100 transform translate-y-4 group-hover:translate-y-0 transition-all duration-500 delay-75">
            <a href="pack-detail.html?id=${s.id}" class="text-white text-sm font-bold flex items-center gap-1">Ver detalles <span class="material-icons-outlined text-sm">arrow_forward</span></a>
