    ...
    card.innerHTML = `
      ...
      <div class="absolute bottom-0 left-0 p-6 w-full">
        ...
        <div class="flex items-center gap-3">
          <button class="text-white text-sm font-bold flex items-center gap-1 opacity-0 group-hover:opacity-100 transform translate-y-4 group-hover:translate-y-0 transition-all duration-500 delay-75">Ver paquete <span class="material-icons-outlined text-sm">arrow_forward</span></button>
